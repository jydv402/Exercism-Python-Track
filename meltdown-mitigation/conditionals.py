...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    status_determiner = temperature * neutrons_produced_per_second
    return 'LOW' if status_determiner < threshold * 0.9 else ('NORMAL' if status_determiner < threshold * 1.1 else 'DANGER')
