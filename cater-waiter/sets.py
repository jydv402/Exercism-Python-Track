...
def tag_special_ingredients(dish):
    ...
    set_of_ingredients = set(dish[1]).intersection(SPECIAL_INGREDIENTS)
    return(dish[0],set_of_ingredients)
...
def separate_appetizers(dishes, appetizers):
    ...
    """
    anti_appetizers = set(dishes).difference(set(appetizers))
    return list(anti_appetizers)
